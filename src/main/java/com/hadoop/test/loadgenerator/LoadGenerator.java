 ...
 * different client loads. Note there is a subclass of this class that lets 
 ...
 */
public class LoadGenerator extends Configured {
  ...
  */
  ...
  public static void main(String[] args) throws Exception {
    LoadGenerator lg = new LoadGenerator(new Configuration());
    System.exit(lg.run(args));
  }
}
